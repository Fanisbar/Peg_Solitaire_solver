...
from board import create_english_board, create_diamond_board, create_fireplace_board, apply_move, INVALID, EMPTY, PEG
from problem import PegSolitaireProblem
from search import dfs

if len(sys.argv) < 2:
    print("Warning: a board configuration must be provided as an argument.")
    print("Please try again with one of the folowing options: english, diamond, fireplace")
    sys.exit(1)
